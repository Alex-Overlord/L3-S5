...
-- CREATE TABLE Nb_emp_ab ( -- nombre d'emprunt par abonne
--   nea_num_ab NUMERIC(6,0),
--   nea_nb_emp INT(3),
--   CONSTRAINT fk_nea_num_ab FOREIGN KEY nea_num_ab REFERENCES Abonne(ab_num),
--   CONSTRAINT pk_nb_emp_ab PRIMARY KEY (Nb_emp_ab)
-- );
