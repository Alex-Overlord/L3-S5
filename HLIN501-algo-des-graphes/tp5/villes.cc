...
void itineraire(int i, int j, int chemin[][N], char villes[][20]) {
  cout << "Depart: " << villes[i] << " ";
  cout << "Destination: " << villes[j] << " ";
  cout << "Itinéraire: ";
  int a = i;
  int b = chemin[i][j];
  int tmp;
...
void allItineraire(int chemin[][N], char villes[][20]) {
  for (int l=0; l<N; l++) {
    for (int c=0; c<N; c++) {
      itineraire(l, c, chemin, villes);
    }
  }
}

int main() { 
  char villes[41][20]={"Amiens", "Angouleme", "Avignon", "Bayonne", "Bilbao", "Bordeaux"
    , "Bourges", "Brest", "Brive", "Bruxelles", "Caen", "Cahors", "Clermont-Ferrand"
    , "Dijon", "Geneve", "Grenoble", "Lille", "Limoges", "Luxembourg", "Lyon", "Marseille"
    , "Millau", "Montpellier", "Mulhouse", "Nancy", "Nantes", "Nice", "Orleans", "Paris"
    , "Perpignan", "Poitiers", "Reims", "Rennes", "Rodez", "Rouen", "Saint-Etienne", "Strasbourg"
    , "Toulouse", "Tours", "Troyes", "Valence"};

  int position[41][2]={{282,84},{180,334},{412,443},{140,455},{80,480},{165,389},{304,253}
    ,{14,150},{249,365},{380,15},{182,117},{258,412},{322,322},{408,231},{470,287},{464,359}
    ,{324,32},{242,332},{470,60},{405,306},{433,480},{339,440},{365,461},{497,208},{453,148}
    ,{116,233},{515,460},{277,194},{296,146},{329,505},{208,271},{369,119},{120,175},{330,410}
    ,{228,101},{383,339},{508,152},{227,466},{220,230},{363,179},{408,377}};
  ...
  #pragma region init longueur avec les bonnes valeurs
